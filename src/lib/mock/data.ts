...
const PROFILES: Record<string, StreamProfile> = {
  mba: {
    ...
    courses: [
      ...
      course("MBA in Human Resources", "Postgraduate", "2 years", "INR 2L - 20L"),
      course("MBA in Operations", "Postgraduate", "2 years", "INR 2L - 20L"),
      course("MBA in Business Analytics", "Postgraduate", "2 years", "INR 3L - 24L"),
      course("MBA in International Business", "Postgraduate", "2 years", "INR 2L - 22L"),
      course("MBA in Information Technology", "Postgraduate", "2 years", "INR 2L - 20L"),
      course("MBA in Healthcare Management", "Postgraduate", "2 years", "INR 2L - 18L"),
      course("MBA in Entrepreneurship", "Postgraduate", "2 years", "INR 2L - 20L"),
      course("Executive MBA", "Postgraduate", "1 year", "INR 4L - 30L"),
      course("Online MBA", "Postgraduate", "2 years", "INR 1L - 6L"),
    ],
  ...
  engineering: {
    ...
    courses: [
      ...
      course("B.Tech Civil", "Undergraduate", "4 years", "INR 2L - 12L"),
      course("B.Tech Information Technology", "Undergraduate", "4 years", "INR 2L - 14L"),
      course("B.Tech AI and Machine Learning", "Undergraduate", "4 years", "INR 3L - 18L"),
      course("B.Tech Data Science", "Undergraduate", "4 years", "INR 3L - 18L"),
      course("B.Tech Electrical", "Undergraduate", "4 years", "INR 2L - 12L"),
      course("B.Tech Chemical", "Undergraduate", "4 years", "INR 2L - 12L"),
  ...
  medical: {
    ...
    courses: [
      ...
      course("BAMS", "Undergraduate", "5.5 years", "INR 1L - 10L"),
      course("BHMS", "Undergraduate", "5.5 years", "INR 1L - 9L"),
      course("B.Pharm", "Undergraduate", "4 years", "INR 1L - 8L"),
      course("BPT Physiotherapy", "Undergraduate", "4.5 years", "INR 1L - 6L"),
      course("BSc Medical Lab Technology", "Undergraduate", "3 years", "INR 0.6L - 4L"),
      course("BSc Radiology", "Undergraduate", "3 years", "INR 0.8L - 5L"),
  ...
  law: {
    ...
    courses: [
      ...
      course("B.Com LLB", "Undergraduate", "5 years", "INR 1L - 12L"),
      course("LLB", "Undergraduate", "3 years", "INR 0.6L - 6L"),
      course("LLM Corporate Law", "Postgraduate", "1 year", "INR 1L - 5L"),
      course("LLM Criminal Law", "Postgraduate", "1 year", "INR 1L - 5L"),
      course("LLM Constitutional Law", "Postgraduate", "1 year", "INR 1L - 5L"),
      course("Diploma in Cyber Law", "Diploma", "1 year", "INR 0.4L - 2L"),
      course("Diploma in Corporate Law", "Diploma", "1 year", "INR 0.4L - 2L"),
...
function genericProfile(streamSlug: string): StreamProfile {
  ...
  return {
    ...
    courses: [
      ...
      course(`B.Com ${label}`, "Undergraduate", "3 years", "INR 0.4L - 3L"),
      course(`MA ${label}`, "Postgraduate", "2 years", "INR 0.6L - 3L"),
      course(`MSc ${label}`, "Postgraduate", "2 years", "INR 0.7L - 3L"),
      course(`Diploma in ${label}`, "Diploma", "1 year", "INR 0.3L - 1.5L"),
      course(`Certificate in ${label}`, "Certificate", "6 months", "INR 0.2L - 1L"),
    ],
