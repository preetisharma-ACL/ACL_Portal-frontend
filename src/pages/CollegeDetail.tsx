...
/**
 * School of Management Sciences, Varanasi — the one college wired with a direct
 * call line. The "Call Now" CTA appears only on its page.
 */
const SMS_COLLEGE_ID = 168;
const SMS_COLLEGE_TEL = "+919511050627";
              ...
              <div class="container-x pb-6">
                ...
                <div class="mt-3 flex flex-col gap-5 lg:flex-row lg:items-start lg:justify-between">
                  ...
                  <div class="flex flex-wrap items-center gap-2.5 lg:shrink-0 lg:justify-end lg:pt-1">
                    {/* Direct call line — SMS Varanasi only. */}
                    <Show when={parsed().id === SMS_COLLEGE_ID}>
                      <a
                        href={`tel:${SMS_COLLEGE_TEL}`}
                        aria-label="Call now"
                        class={buttonClass(
                          "primary",
                          "md",
