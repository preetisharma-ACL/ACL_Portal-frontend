...
import { Badge, Card, LinkButton, Rating } from "~/components/ui";
                  ...
                  <div class="flex-1 min-w-0">
                    ...
                    <div class="mt-2 flex flex-wrap items-center gap-2">
                      <Show when={h().rating > 0}>
                        <span class="inline-flex items-center gap-1 text-sm font-semibold bg-white/15 px-2 py-0.5 rounded-full">
